...
from ._sentinel import Unset, UnsetType, not_sentinel
...
def _extract_from_forward_ref(
    ...
    """Extract FK/Vector metadata from a ForwardRef string.

    Handles annotations like 'FK[Evidence] | None' from 'from __future__ import annotations'.
    """
    ...
    if fk_match:
        ...
        fk = FKMeta(model_name)  # Pass string, will be resolved later or use convention
