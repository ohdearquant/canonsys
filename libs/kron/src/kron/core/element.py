"""Element: Base element with UUID identity, timestamps, and polymorphic serialization.

Provides Element class, the foundation for Node and all persistent entities.
"""
...
from kron.types import MaybeSentinel, Unset, UnsetType, is_sentinel, is_unset
