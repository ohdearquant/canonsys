"""HTTP endpoint backend for canon services.
...
class APICalling(Calling):
    ...
    def __init__(
        ...
        """Initialize API calling with endpoint and payload.

        Args:
            backend: Endpoint instance.
            payload: Request payload.
            timeout: Optional timeout in seconds.
            streaming: Enable streaming mode.
            extra_headers: Additional headers for request.
        """
        super().__init__(backend, payload, timeout, streaming)
